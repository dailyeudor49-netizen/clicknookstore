...
export default function Home() {
  return (
    <div className="bg-white">
      {/* Hero */}
      <section className="bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <span className="text-slate-400 text-sm font-medium">Wholesale Tech Supplier</span>
              <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-5">
                Premium Tech, <span className="text-slate-400">Best Prices</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/products" className="px-6 py-3 bg-slate-600 hover:bg-slate-500 text-white font-medium rounded-lg">
                  View Products
                </Link>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="p-5 bg-gray-800/50 rounded-xl text-center">
                    <div className="text-2xl font-bold text-slate-400">{s.n}</div>
      ...
      {/* Mobile Stats */}
      <section className="md:hidden py-8 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-4 gap-2 text-center">
          {[
            ...
            <div key={i}>
              <div className="text-lg font-bold text-slate-600">{s.n}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <Link key={i} href={c.h} className="p-4 bg-gray-50 rounded-xl text-center hover:bg-slate-50 hover:ring-2 hover:ring-slate-200 transition-all">
      ...
      <section className="py-16 md:py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-10">Why Clicknook?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-5 bg-gray-800 rounded-xl">
                <div className="w-8 h-8 bg-slate-600 rounded-lg flex items-center justify-center mb-3">
      ...
      {/* CTA */}
      <section className="py-16 md:py-20 bg-slate-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Order?</h2>
          <p className="text-slate-100 mb-8">Contact us for a personalised quote. No minimum for first orders.</p>

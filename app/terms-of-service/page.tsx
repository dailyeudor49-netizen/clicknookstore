...
export const metadata: Metadata = {
  ...
  description: "Clicknook terms and conditions for using our services.",
};
    ...
    <div className="bg-white">
      ...
      <section className="py-14">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose pslate-gray max-w-none space-y-8">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">1. Agreement to Terms</h2>
              <p className="text-gray-600">
                By accessing or using Clicknook&apos;s website and services, you agree to be bound by these Terms of Service. If you disagree with any part, you may not access our services.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Clicknook AS provides wholesale electronics and tech gadgets. All products are subject to availability. We reserve the right to modify or discontinue products without notice. Prices are subject to change.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 text-gray-600 space-y-1">
                ...
                <li>Prices are quoted in NOK unless otherwise stated</li>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Clicknook AS shall not be liable for any indirect, incidental, or consequential damages arising from use of our products or services. Our total liability shall not exceed the amount paid for the specific product or service.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                All content on this website, including text, graphics, logos, and images, is the property of Clicknook AS and protected by intellectual property laws. Unauthorised use is prohibited.
              </p>
            </div>
